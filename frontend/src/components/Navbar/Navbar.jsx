...
const Navbar = ({ setShowLogin }) => {
  ...
  // Function to handle scroll to the top when "Menu" is clicked
  const scrollToTop = () => {
    const element = document.getElementById('top-of-page'); // Replace with your target element ID
    if (element) {
...
>
    Home
        ...
        <a
          ...
          onClick={() => {
            setMenu('menu');
            scrollToTop(); // Call the scroll function when clicking "Menu"
          }}
      ...
      <div className="navbar-right">
        <div className="navbar">
          <label for="visual-toggle" id="visual-toggle-button">
            <svg
